...
public class TestWebService {
     ...
     * Web service operation
     */
    @WebMethod(operationName = "sendId")
    public Integer sendId(@WebParam(name = "parameter") int parameter) {
         System.out.println("[Server] - Server has Recieved Message From : " + parameter);
