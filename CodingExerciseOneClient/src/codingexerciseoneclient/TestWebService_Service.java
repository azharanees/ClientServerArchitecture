 ...
 * 
 */
@WebServiceClient(name = "TestWebService", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8080/CodingExerciseOneServer/TestWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/CodingExerciseOneServer/TestWebService?wsdl");
