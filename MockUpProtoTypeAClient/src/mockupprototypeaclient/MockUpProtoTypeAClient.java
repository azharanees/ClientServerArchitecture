 ...
 * @author Azhar
 */
public class MockUpProtoTypeAClient {
    mockupprototypeaclient.MockUpPrototypeService_Service s  =   new mockupprototypeaclient.MockUpPrototypeService_Service();
    mockupprototypeaclient.MockUpPrototypeService server  = s.getMockUpPrototypeServicePort();
  ...
  public static void main(String[] args) 
    {
        MockUpProtoTypeAClient client  =   new MockUpProtoTypeAClient();
        client.executeTest();
    }
    ...
    private void executeTest() 
    {
        ...
        */
        if(server.isConnected())
        {
            ...
            */
            if(server.findShortestBetween("Short", "Very very long").equals("Short"))
            ...
            */            
            try {
                if(server.findShortestBetweenWithException("Short", "Very very long").equals("Short"))
                    System.out.println("[CLIENT] - findShortestBetweenWithExcep gave a correct result");
                else
                    System.out.println("[CLIENT] - findShortestBetweenWithExcep gave a WRONG result");
