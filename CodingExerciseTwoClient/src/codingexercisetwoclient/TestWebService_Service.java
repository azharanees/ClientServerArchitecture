 ...
 * 
 */
@WebServiceClient(name = "TestWebService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/CodingExerciseTwoServer/TestWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/CodingExerciseTwoServer/TestWebService?wsdl");
