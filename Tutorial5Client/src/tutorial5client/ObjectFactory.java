 ...
 * generated in the tutorial5client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://server/", "operation");
    ...
    private final static QName _OperationResponse_QNAME = new QName("http://server/", "operationResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tutorial5client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "operationResponse")
