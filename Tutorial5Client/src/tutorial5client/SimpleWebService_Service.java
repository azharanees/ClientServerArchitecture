 ...
 * 
 */
@WebServiceClient(name = "SimpleWebService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/Tutorial5Web/SimpleWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Tutorial5Web/SimpleWebService?wsdl");
